...
<div class="container-full">
      ...
      <div class="row">
        ...
        <div class="col-lg-12 text-center v-center">
          ...
          <form action="up.php" method="post" enctype="multipart/form-data" class="col-lg-12">
            ...
            <input class="form-control input-lg" name="file" type="file">
              <span class="input-group-btn"><button class="btn btn-lg btn-primary" name="submit" type="submit">Upload</button></span>
            </div>
          </form>
        </div>
